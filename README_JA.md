...
シェーディングに利用されるシェーダーはJaredNytsが作成した[Wuthering Wavesモデルに最適化されたシェーダー](https://discord.com/channels/894925535870865498/1213552094678614038/1272958039221338114)と、Jonnが作成した[Wuthreing Waves 3.0モデル以降に最適化されたシェーダー](https://discord.com/channels/894925535870865498/1454938172604551383)をサポートしています。
Jonnシェーダーに関しては、インポートを実行できるように整えたものを当方が[まとめたシェーダーマテリアルBlendをここで](https://github.com/fnoji/Blender-WuWa-Jonn-Shader)公開しています。
リグとフェイスリグに利用されているスクリプトの源流はScheinzeが[作成したもの](https://discord.com/channels/894925535870865498/1320434868806615122/1320434868806615122)で、最終版から当方が最適化や分岐処理しています。
